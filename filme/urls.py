# Criar sempre 3 coisas: URL, View e Template
...
# <int:pk>: ele indentifica que esse parâmetro (valor depois da /) tem que ser a primary key (pk) de um item do modelo
# Nesse caso,é basicamente para dizer que,para acessar um filme específico,basta colocar o id do filme após o 'filmes/'